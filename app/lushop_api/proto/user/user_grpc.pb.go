...
type UserClient interface {
	...
	UpdatePassword(ctx context.Context, in *UpdatePasswordInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userClient) UpdatePassword(ctx context.Context, in *UpdatePasswordInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type UserServer interface {
	...
	UpdatePassword(context.Context, *UpdatePasswordInfo) (*emptypb.Empty, error)
...
func (UnimplementedUserServer) UpdatePassword(context.Context, *UpdatePasswordInfo) (*emptypb.Empty, error) {
...
func _User_UpdatePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdatePassword(ctx, req.(*UpdatePasswordInfo))
	}
	return interceptor(ctx, in, info, handler)
}
