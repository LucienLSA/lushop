...
func Get_policy_token() string {
	...
	h := hmac.New(func() hash.Hash { return sha1.New() }, []byte(global.GetEnvInfoStr(global.ServerConfig.OssInfo.ApiSecrect)))
	...
	policyToken.AccessKeyId = global.GetEnvInfoStr(global.ServerConfig.OssInfo.ApiKey)
