...
func main() {
	dsn := "root:123456@tcp(127.0.0.1:3306)/lushop_userop_srv?charset=utf8mb4&parseTime=True&loc=Local"
	...
	err = _db.AutoMigrate(&model.LeavingMessages{}, &model.Address{}, &model.UserFav{})
	if err != nil {
		// Todo log
		panic(err)
	}
